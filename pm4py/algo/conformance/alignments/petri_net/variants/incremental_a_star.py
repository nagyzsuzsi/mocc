'''
    ...
    Author: Daniel Schuster (original), Zsuzsanna Nagy (modifications)
'''
...
from pm4py.objects.petri_net.utils.align_utils import SKIP, pretty_print_alignments as print_alignment
...
def apply(trace, petri_net, initial_marking, final_marking, parameters=None, debug_print=False, derive_heuristic=True,
          dijkstra=False, recalculate_heuristic_open_set=True, mode=0):
...
def __search(sync_net, initial_m, final_m, cost_function, skip, open_set_heap, closed_set, derive_heuristic=False,
             dijkstra=False, recalculate_heuristic_open_set=True, complete_trace=False):
    number_solved_lps = 0
